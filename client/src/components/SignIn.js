...
const CustomButton = ({ children, isLoading, onClick }) => {
    ...
    return (
        <Button isLoading={isLoading} height="50px" variantColor="blue" variant="outline" backgroundColor="white" mr={3} onClick={onClick}>
            {children}
        </Button>
    );
};
    ...
    return (
        <div>
            <main>
                ...
                <Flex h="15vh" justify="center" alignItems="center" grow="10" bg="#e5f4f1">
