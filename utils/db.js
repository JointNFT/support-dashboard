...
const updateOrganizationDetails = async (organizationId, createdBy, totalConversations, prioritized, closed, staff) => {
    var customers = totalConversations - closed;
    let dbParams = {
        TableName: "Organization",
        ExpressionAttributeNames: {
        ...
        UpdateExpression: 'set #totalConversations = :totalConversations, #prioritized= :prioritized, #closed = :closed, #staff = :staff, #customers = :customers',
        ExpressionAttributeValues: {
            ':totalConversations': totalConversations,
            ':prioritized' : prioritized,
            ':closed' : closed,
...
module.exports = {
    ...
    assignConversation, closeConversation, updateOrganizationDetails
};
